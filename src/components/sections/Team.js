...
export default function Team() {
  ...
  return (
    <section id="team" className="relative py-32 overflow-hidden">
      ...
      {/* Background Ambience - Matches Hero/Footer style for seamless blending */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-20 text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
            Meet the <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-pink to-purple-600">Visionaries.</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {team.map((member, i) => (
            <Card key={i} className="p-8 group hover:bg-white/[0.03] transition-all duration-500">
